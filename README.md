...
•	اجماع تمام نیروهای ریشه دار و موثر در تاریخ معاصر ایران، اعم از گروه‌های سکولار، فمینیست، دمکرات، سلطنت‌طلب، چپ، مذهبی، ملی‌گرا و غیره که هر یک در مانیفست خود به روشنی اهداف و ارزش‌های خود را به اطلاع عموم رسانده‌اند و توسط چهره‌ای سیاسی در شورای ائتلاف نمایندگی می‌شوند.
•	شفافیت سازوکار این نمایندگی می‌تواند از طریق رای مستقیم بدنه این گروه‌های سیاسی و با اتکا به تکنولوژی‌های جدید تضمین شود.
•	هدف اول اعضای ائتلاف، تدوین و انتشار پیش‌نویسی برای قانون اساسی آینده ایران است، به نحوی که پس از جمهوری اسلامی، وجود فضای رقابت سالم برای نیروهای سیاسی متکثر تضمین شود.
•	اعضای ائتلاف از تفاوت‌های مهم خود آگاهند، آنها را به رسمیت می‌شناسند و در حین تدوین قانون اساسی آینده، از آنها به عنوان محکی بر تاب‌آوری و جامعیت قانون بهره می‌گیرند.
